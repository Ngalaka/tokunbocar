            ...
            <form action="" onSubmit={handleSubmit(onSubmit)}>
              ...
              <div className="w-full py-2 lg:w-full ">
                <span className="text-black/40 ">
                  Never disclose your logos used car password to anyone
                </span>
              </div>
              ...
              <div className=" w-full mx-auto lg:w-full l  flex flex-col justify-center items-center gap-2 py-2 ">
                <button
                  type="submit"
                  disabled={loading}
                  className={`w-full h-auto p-2   lg:p-2 rounded-lg text-white lg:w-full lg:auto mx-auto   ${loading ? "bg-blue-600 cursor-not-allowed" : "bg-blue-900 hover:bg-blue-700"}`}
                >
