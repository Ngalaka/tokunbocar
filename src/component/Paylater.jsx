...
<div className='w-[80%] py-4 mx-auto lg:w-full h-auto lg:py-8 lg:px-4'>
        {payment.map((pay) => (
          <div key={pay.id} >
      ...
      <div className='w-full h-auto bg-blue-950 text-white'>
        ...
        <div className='w-[90%] h-auto bg-blue-900 py-4 px-4 m-auto rounded-lg'>
        ...
        <div className='w-full h-auto py-8 '>
          <button className='w-[90%]  gap-4 lg:w-[70%] h-auto b text-white bg-transparent mx-auto rounded-lg border border-white cursor-pointer py-4 px-4 text-xl font-semibold flex justify-center items-center lg:gap-8'>
            Check Eligibility
