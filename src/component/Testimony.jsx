  ...
  return (
    <>
      ...
      <div className="w-full h-auto">
        ...
        <div className="w-full px-4 py-2 flex flex-row justify-between items-center lg:px-16lg: lg:py-4">
            ...
            <div className=" w-full flex-col justify-center items-center lg:w-[80%] h-auto flex lg:flex-row lg:justify-between lg:items-center gap-2 border">
              {testimony.map((testi) => (
                ...
                < SwiperSlide key={testi.id} >
                  <div className="border  border-black/10 py-2 px-2">
                    <div className="w-full h-auto lg:h-20 text-sm lg:w-full flex items-center justify-center lg:text-center  text-black/50">
                      <p >{testi.testi}</p>
                    </div>
